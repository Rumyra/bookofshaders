...
#define TWO_PI 6.28318530718
 ...
 //    return vec3(abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);
	...
	// this is our rotate matrix, we multiply this by our vector to rotate the shape
	...
	void main() {
		...
		// it's a bit like rotating on canvas, where you have to move the whole thing and then move it back again
