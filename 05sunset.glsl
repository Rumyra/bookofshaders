...
#define PI 3.14159265359
	...
	vec3 night = vec3(0.0, 0.0, 1.0);
	vec3 sunrise = vec3(0.5, 0.5, 0.0);
	vec3 day = vec3(0.0, 0.5, 0.5);
	vec3 sunset = vec3(0.5, 0.0, 0.5);
    ...
    pct.r = sin(u_time/2.0)+1.0;
    pct.g = sin(u_time/4.0)+1.0;
    pct.b = sin(u_time/4.0);

		color = mix(color, red, pct.r);
		color = mix(color, green, pct.g);
		color = mix(color, blue, pct.b);
